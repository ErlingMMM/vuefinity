<template>
  ...
  export default {
    data() {
      return {
        ...
        correctImage: '',
        countdown: 30,
        userEmail: '', // Add this data property
      };
    },
    mounted() {
  ...
  setInterval(() => {
    if (this.countdown > 0) {
      ...
      // const userEmail = this.$route.params.userEmail; // Remove this line
      ...
      if (totalPoints > userHighScore) {
        ...
        userService.putUser(this.$route.params.userEmail, { highScore: totalPoints });
